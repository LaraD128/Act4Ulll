  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title:
            const Text('ROPA leFLEUR*', style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xffd1d29c),
        elevation: 8,
      ),
      body: Padding(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image(
                image: NetworkImage(
                    "https://raw.githubusercontent.com/LaraD128/img_iOS/main/fle/camisa1.jpg")),
